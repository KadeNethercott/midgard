 ...
 *
 * <pre>
 *   midgardDev = angular.module('midgardDev', ['midgard', 'ngMockE2E']);
 *   midgardDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * <pre>
   *
   *   angular.module('midgardlicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('midgardlicationModule'));
   *
   *
